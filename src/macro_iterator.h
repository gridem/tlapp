...
#define macro_choose(D_name, ...)                                               \
  macro_arg10(dummy, ##__VA_ARGS__, D_name##9, D_name##8, D_name##7, D_name##6, \
      D_name##5, D_name##4, D_name##3, D_name##2, D_name##1, D_name##0)
...
#define macro_iterate1_2(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_1(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_3(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_2(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_4(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_3(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_5(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_4(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_6(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_5(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_7(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_6(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_8(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_7(D_for, D_arg1, D_delim, __VA_ARGS__)
#define macro_iterate1_9(D_for, D_arg1, D_delim, D_1, ...) \
  D_for(D_arg1, D_1) D_delim() macro_iterate1_8(D_for, D_arg1, D_delim, __VA_ARGS__)
...
#define macro_rotate_8(_, D1, D2, D3, D4, D5, D6, D7, D) D, D1, D2, D3, D4, D5, D6, D7
#define macro_rotate_9(_, D1, D2, D3, D4, D5, D6, D7, D8, D) \
  D, D1, D2, D3, D4, D5, D6, D7, D8

// The last param becomes the first.
// Sample: macro_rotate(A, B, X) => X, A, B
#define macro_rotate(...) macro_choose(macro_rotate_, ##__VA_ARGS__)(_, ##__VA_ARGS__)
...
#define macro_iterate(D_for, ...) macro_iterate_delim(D_for, macro_empty, ##__VA_ARGS__)
...
#define macro_iterate_delim_arg(D_for, D_arg, D_delim, ...) \
  macro_choose(macro_iterate1_, ##__VA_ARGS__)(D_for, D_arg, D_delim, ##__VA_ARGS__)
